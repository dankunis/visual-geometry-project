...
def check_version():
    ...
    if "3" not in sys.version:
        print("[Info] : You are running python version " + sys.version + ". We recommend python 3.7.2 for expected performance.")
    else:
        print("[Info] : You are running python version " + sys.version + ".")

    if "3" not in cv2.__version__:
        print("[Info] : You are running cv2 version " + cv2.__version__ + ". We recommend cv2 3.4.2 for expected performance.")
    else:
